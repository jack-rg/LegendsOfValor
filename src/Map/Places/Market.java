...
public class Market extends Place {
	...
	public void marketSequence(LegendsOfValor game) {
	...
	public void shopSequence(LegendsOfValor game) {
	...
	public void attemptSellWeapon(LegendsHero activeHero) {
		while (true) {
			System.out
					.println("What would you like to part with? Input the corresponding int, or input -1 to go back.");
