...
public abstract class Game{
  ...
  //initializes players, objects (such as decks or boards), sets status to begin, and updates over time
  public Game(){
    initPlayers();
  ...
  //generic method for asking players if they want to continue playing or if they wish to complete
  public void replay(){
